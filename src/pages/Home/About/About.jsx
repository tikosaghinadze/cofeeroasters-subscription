...
const About = () => {
  return (
    <div className="w-full flex flex-col items-center">
      <div className=" px-6  pt-[111px] pb-[87px] w-full flex bg-aboutCofee rounded-[10px] flex-col justify-center items-center h-[400px] bg-no-repeat bg-cover ">
        <h2 className="pb-6 font-body-font1 text-[28px] text-light font-black">
          About Us
        </h2>
        <p className="text-[15px] font-body-font2 text-light font-normal text-center">
      ...
      <div className="relative px-6 pt-[120px] w-full flex flex-col items-center h-[542px] bg-darkBlue opacity-2 rounded-[10px] mt-[198px]">
        ...
        <div className="w-full flex flex-col items-center gap-6">
          ...
          <p className="text-center font-normal text-[15px] text-light font-body-font2 leading-[25px] ">
